...
export const images: Artwork[] = [
  {
    ...
    subtitle: 'A nocturnal automotive key visual',
    project: 'Nocturne / Automotive',
    description: 'A finished automotive key visual imagining a silent luxury launch on the edge of a volcanic coastline.',
    category: 'Campaign Key Visual', sector: 'Automotive', status: 'portfolio', featured: true,
  ...
  },
  {
    id: 'soft-power',
    title: 'Soft Power',
    subtitle: 'Beauty direction in tactile light',
    ...
    category: 'Campaign Visual', sector: 'Beauty', status: 'portfolio',
